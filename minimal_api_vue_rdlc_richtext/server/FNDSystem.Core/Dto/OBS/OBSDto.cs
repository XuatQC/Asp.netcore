...
namespace FNDSystem.Core.Dto
{
    public class ObsDto
    {
        ...
        public string? ApprovalStateSlState { get; set; }
    ...
    public class ObsDtoValidator : AbstractValidator<ObsDto>
    {
        public ObsDtoValidator()
        {
            ...
            RuleFor(x => x.TranslatingStateId).Length(0, 3);
            RuleFor(x => x.TranslatedStateId).Length(0, 3);
            ...
            RuleFor(x => x.ApprovalStateSlState).Length(0, 25);
