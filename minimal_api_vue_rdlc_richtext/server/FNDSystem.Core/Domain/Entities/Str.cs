...
namespace FNDSystem.Core.Domain.Entities
{
    ...
    public partial class Str
    {
        ...
        [Column("branch_num")] public  int SerialNum { get; set; }
        ...
        [Column("translated_state")][MaxLength()] public  bool TranslatedState { get; set; }
        ...
        [Column("approval_state_tl")][MaxLength()] public  bool ApprovalStateTl { get; set; }
