...
{
    [Keyless]
    [Table("vw_obs_control")]
    public class VwObsControl
    {
        [Column("plant_name")] public required string PlantName { get; set; }
        [Column("kinds")] public required string Kinds { get; set; }
        [Column("fields")] public required string Fields { get; set; }
        [Column("part_id")] public required string PartId { get; set; }
        [Column("serial_num")] public required int SerialNum { get; set; }
        [Column("revisions")] public required int Revisions { get; set; }
        [Column("num_no_revisions")] public string NumNoRevisions { get; set; } = string.Empty;
        ...
        [Column("scope_trans")] public string? ScopeTrans { get; set; }
        [Column("scope_comment")] public string? ScopeComment { get; set; }
        [Column("part_trans_scope")] public bool? PartTransScope { get; set; }
        ...
        [Column("language")][MaxLength(3)] public string? Language { get; set; }
    }
}
