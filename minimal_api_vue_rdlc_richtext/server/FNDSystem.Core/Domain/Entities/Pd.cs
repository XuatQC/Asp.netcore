...
namespace FNDSystem.Core.Domain.Entities
{
    ...
    public partial class Pd
    {
        ...
        [Column("title_part_trans")] public bool TitlePartTrans { get; set; }
        [Column("explan_text")] public string? ExplanText { get; set; }
        [Column("explan_text_trans")] public string? ExplanTextTrans { get; set; }
        [Column("part_trans")] public bool PartTrans { get; set; }
        [Column("explan_text_translation")] public bool ExplanTextTranslation { get; set; }
        [Column("explan_text_jude")] public bool ExplanTextJude { get; set; }
        [Column("explan_text_jdc")][MaxLength(1000)] public string? ExplanTextJdc { get; set; }
        ...
        [Column("connect_memo")][MaxLength(30)] public string? ConnectMemo { get; set; }
