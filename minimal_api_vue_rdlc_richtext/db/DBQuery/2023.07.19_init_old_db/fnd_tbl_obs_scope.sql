...
--
-- Table structure for table `tbl_obs_scope`
--

DROP TABLE IF EXISTS `tbl_obs_scope`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_obs_scope` (
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='OBC範囲テーブル';
...
-- Dump completed on 2023-07-19 12:56:07
