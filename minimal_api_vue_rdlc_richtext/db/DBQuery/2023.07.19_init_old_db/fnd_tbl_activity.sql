...
CREATE TABLE `tbl_activity` (
  ...
  `target` varchar(10) DEFAULT NULL COMMENT '対象',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='観察対象マスタ';
...
-- Dump completed on 2023-07-19 12:56:06
