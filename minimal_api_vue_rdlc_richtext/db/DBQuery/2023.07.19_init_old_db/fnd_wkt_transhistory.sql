...
CREATE TABLE `wkt_transhistory` (
  ...
  `japanese_sentence` mediumtext COMMENT '和文',
  `english` mediumtext COMMENT '英文',
  `translated_flag` tinyint DEFAULT '0' COMMENT '翻訳済',
  `display_order` int DEFAULT '0' COMMENT '表示順',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wkt_TransHistory';
